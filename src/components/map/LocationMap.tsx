...
const defaultCenter = { lat: 22.3193, lng: 114.1694 }; // 香港中心点
          ...
          >
            <div className="p-2 max-w-xs">
              ...
              <div className="flex flex-wrap gap-2 mb-2">
                ...
                <Badge className={`bg-${selectedLocation.status === 'active' ? 'green' : 'red'}-100 text-${selectedLocation.status === 'active' ? 'green' : 'red'}-600`}>
                  {t(`locations.status.${selectedLocation.status}`)}
                </Badge>
              </div>
              ...
              {selectedLocation.status === 'active' && (
                <>
                  <div className="flex items-center gap-1 text-sm text-brand-neutral-500">
                    <Clock className="h-4 w-4" />
                    <span>
                      {t('locations.lastRefill')}: {selectedLocation.lastRefill}
                    </span>
