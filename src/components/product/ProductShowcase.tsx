          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            >
              {/* <div className="relative aspect-square rounded-lg overflow-hidden">
                <Image 
                  src={productImages[selectedVersion][selectedImage].src}
                  alt={productImages[selectedVersion][selectedImage].alt}
                  fill
              ...
              <div className="grid grid-cols-4 gap-4 mt-4">
                {productImages[selectedVersion].map((image, index) => (
                  <button
                    key={index}
