...
//       id: 1,
//       icon: Users,
//       // 修改前: value: t('impact.metrics.activeUsers'),
//       // 修改后:
//       value: t('impact.metrics.activeUsers.total'),
//       title: t('impact.metrics.activeUsers.title'),
//       description: t('impact.metrics.activeUsers.description'),
//       trend: 'up',
//       lastMonth: t('impact.metrics.activeUsers.lastMonth')
//     },
//     {
//       id: 2,
//       icon: Battery,
//       // 修改前: value: t('impact.metrics.energyReduction'),
//       // 修改后:
//       value: t('impact.metrics.energyReduction.total'),
//       title: t('impact.metrics.energyReduction.title'),
//       description: t('impact.metrics.energyReduction.description'),
//       trend: 'up',
//       lastMonth: t('impact.metrics.energyReduction.lastMonth')
//     },
//     {
//       id: 3,
//       icon: LeafyGreen,
//       // 修改前: value: t('impact.metrics.co2Saved'),
//       // 修改后:
//       value: t('impact.metrics.co2Saved.total'),
//       title: t('impact.metrics.co2Saved.title'),
//       description: t('impact.metrics.co2Saved.description'),
//       trend: 'up',
//       lastMonth: t('impact.metrics.co2Saved.lastMonth')
//     }
//   ];
